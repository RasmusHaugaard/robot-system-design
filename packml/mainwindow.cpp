...
void MainWindow::initStateMachine()
{
    ...
    _state_unholding        = new MyState("unholding", &_lightstate_pub);
    _state_held             = new MyState("held", &_lightstate_pub);
    _state_holding          = new MyState("holding", &_lightstate_pub);
    _state_idle             = new MyState("idle", &_lightstate_pub);
    _state_starting         = new MyState("starting", &_lightstate_pub);
    _state_execute          = new MyState("execute", &_lightstate_pub);
    _state_completing       = new MyState("completing", &_lightstate_pub);
    _state_complete         = new MyState("complete", &_lightstate_pub);
    _state_resetting        = new MyState("resetting", &_lightstate_pub);
    _state_unsuspending     = new MyState("unsuspending", &_lightstate_pub);
    _state_suspended        = new MyState("suspended", &_lightstate_pub);
    _state_suspending       = new MyState("suspending", &_lightstate_pub);
    _state_stopped          = new MyState("stopped",&_lightstate_pub);
    _state_stopping         = new MyState("stopping",&_lightstate_pub);
    _state_clearing         = new MyState("clearing",&_lightstate_pub);
    _state_aborted          = new MyState("aborted",&_lightstate_pub);
    _state_aborting         = new MyState("aborting",&_lightstate_pub);
