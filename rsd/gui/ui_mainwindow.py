...
# Form implementation generated from reading ui file 'ui_mainwindow_wo_warnings.ui',
# licensing of 'ui_mainwindow_wo_warnings.ui' applies.
#
# Created: Fri Dec 13 12:12:49 2019
...
"}")
        ...
        self.MIRstatusLabel = QtWidgets.QLabel(self.bottomPanel)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MIRstatusLabel.sizePolicy().hasHeightForWidth())
        self.MIRstatusLabel.setSizePolicy(sizePolicy)
        self.MIRstatusLabel.setMinimumSize(QtCore.QSize(50, 40))
        font = QtGui.QFont()
        font.setWeight(50)
        font.setItalic(False)
        font.setBold(False)
        self.MIRstatusLabel.setFont(font)
        self.MIRstatusLabel.setText("")
        self.MIRstatusLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.MIRstatusLabel.setObjectName("MIRstatusLabel")
        self.horizontalLayout_2.addWidget(self.MIRstatusLabel)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QtWidgets.QApplication.translate("MainWindow", "MIR state:", None, -1))
